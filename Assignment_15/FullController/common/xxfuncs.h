...
/* XXDelay is model specific and therefore implemented in FullController.cpp */
/* XXInitialValue is model specific and therefore implemented in FullController.cpp */
...
/* XXStopSimulation is implemented in FullController.cpp */
