 ...
 *
 *  file:  PositionControllerPan.cpp
...
void PositionControllerPan::CopyInputsToVariables (XXDouble *u)
{
...
void PositionControllerPan::CopyVariablesToOutputs (XXDouble *y)
{
...
void PositionControllerPan::Reset(XXDouble starttime)
{
...
bool PositionControllerPan::IsFinished(void)
{
...
void PositionControllerPan::Initialize (XXDouble *u, XXDouble *y, XXDouble t)
{
...
void PositionControllerPan::Calculate (XXDouble *u, XXDouble *y /*, XXDouble t*/)
{
	switch (state)
	{
...
void PositionControllerPan::Terminate (XXDouble *u, XXDouble *y /*, XXDouble t */)
{
	/* copy the inputs */
	CopyInputsToVariables (u);
 ...
 */
void PositionControllerPan::CalculateInitial (void)
{
 ...
 */
void PositionControllerPan::CalculateStatic (void)
{
 ...
 */
void PositionControllerPan::CalculateInput (void)
{
 ...
 * are performed
 */
void PositionControllerPan::CalculateFinal (void)
{
