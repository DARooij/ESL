...
int main()
{
	...
	XXDouble panOffset = MINANGLE; // We will set the offset to the minimum angle, so that the homing procedure will move the system to the minimum angle position
	XXDouble tiltOffset = MINANGLE; // We will set the offset to the minimum angle, so that the homing procedure will move the system to the minimum angle position
