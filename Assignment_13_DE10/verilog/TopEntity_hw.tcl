...
## IP details
##  
set_module_property DESCRIPTION "Full dual motor camera setup"
set_module_property NAME TopEntity 
set_module_property VERSION 1.0
set_module_property GROUP Templates
set_module_property AUTHOR Moll
set_module_property DISPLAY_NAME TopEntity
set_module_property TOP_LEVEL_HDL_FILE TopEntity.v
set_module_property TOP_LEVEL_HDL_MODULE TopEntity
...
add_file TopEntity.v {SYNTHESIS SIMULATION}
...
add_interface PITCH_ENCODER_A conduit end
add_interface_port PITCH_ENCODER_A PITCH_ENC_A export Input 1
