...
/* This file describes the model functions
   ...
   The model itself is the PositionControllerTilt.cpp file
*/
#ifndef PositionControllerTilt_H
...
{
	public:
		enum stateflags_PositionControllerTilt {initialrun, mainrun, finished};

		/**
		 * PositionControllerTilt constructor
		 */
		PositionControllerTilt(void);

		/**
		 * PositionControllerTilt destructor
		 */
		virtual ~PositionControllerTilt(void);

		/**
		 * PositionControllerTilt Initialization of the model and calculation of the values for the start time t
		...
		/**
		 * PositionControllerTilt Calculate
		 * @param u	This is the array with all input signals for this submodel
		 * @param y	This is the array with all output signals from this submodel
		 */
		...
		/**
		 * PositionControllerTilt Terminate
		 * @param u	This is the array with all input signals for this submodel
		 * @param y	This is the array with all output signals from this submodel
		 */
		...
		stateflags_PositionControllerTilt state;
...
#endif	/* PositionControllerTilt_H */
